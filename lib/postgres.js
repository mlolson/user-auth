...
Postgres.prototype._collapseToSingle = function _collapseToSingle(resultArray) {
    return resultArray && resultArray.length ? resultArray[0] : undefined;
};

Postgres.prototype._hashPassword = function(password) {
...
Postgres.prototype._comparePasswords = function(password, passwordHash) {
    return nodefn.lift(bcrypt.compare)(password, passwordHash);
};

Postgres.prototype._cleanUserData = function _cleanUserData(data) {
...
Postgres.prototype.getUserById = function getUserById(userId) {
  return this.getUserByField({cid: userId});
};

Postgres.prototype.getUserByField = function getUserByField(criteria) {
...
Postgres.prototype.updateUser = function updateUser(userId, update) {
    if (!id) {
...
Postgres.prototype.updateUserPassword = function updateUserPassword(userId, password) {
...
Postgres.prototype.createUserWithPassword = function createUserWithPassword(user, password) {
...
//Auth
Postgres.prototype._login = function _login(criteria, password) {
...
Postgres.prototype.loginWithEmail = function loginWithEmail(auth) {
...
Postgres.prototype.loginWithUsername = function loginWithUsername(auth) {
...
//Token
Postgres.prototype.removeSessionToken = function removeSessionToken(tokenString) {
...
Postgres.prototype.getSessionToken = function getSessionToken(tokenString) {
...
Postgres.prototype.createSessionToken = function createSessionToken(user) {
...
Postgres.prototype.getUserAndSessionToken = function getUserFromSessionToken(tokenString) {
...
//Password reset
Postgres.prototype.getPasswordResetToken = function getPasswordResetToken(token) {

};

Postgres.prototype.addPasswordResetToken = function addPasswordResetToken(userId) {

};

Postgres.prototype.removePasswordResetToken = function removePasswordResetToken(token) {
